...
├── questions.js    ★ 題庫（215 題）。老師最常改的就是這個檔案
...
| 模式 | 題數 | 用途 |
|---|---|---|
| 🗺️ 闖關模式 | 五關，中年級每關 5 題、高年級每關 6 題 | 完整教學流程，有故事包裝與通關密語 |
| ⚡ 快速練習 | 隨機 10 題 | 課堂暖身、零碎時間 |
| 🔍 挑戰模式 | 15 題，難度提高 | 比賽前加強 |
| 📋 後測模式 | 中年級 15 題、高年級 20 題 | 正式檢核，語氣中性、無故事包裝，可匯出成績 |
