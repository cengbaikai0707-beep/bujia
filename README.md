...
`math/math-questions.js` 目前共 150 題：基礎補強 42 題、四年級共學 60 題、進階延伸 48 題；每條路徑均含位值、加減、乘法、除法、估算、應用六類。後半段為數感直覺擴充題（湊整、拆解、心算策略、合理性判斷、逆推與多步驟），挑戰題約佔 44%。
...
4. 單一指定單元題數：基礎補強 7 題、四年級共學 10 題、進階延伸 8 題；混合練習可抽 10、15 或 20 題。
